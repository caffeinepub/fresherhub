...
export class Backend implements backendInterface {
    ...
    async createArticle(arg0: string, arg1: string, arg2: string, arg3: Array<string>, arg4: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getArticles(arg0: string | null): Promise<Array<Article>> {
        if (this.processError) {
            try {
                const result = await this.actor.getArticles(to_candid_opt_n3(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async pinArticle(arg0: bigint, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.pinArticle(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateArticle(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: Array<string>, arg5: string): Promise<void> {
        if (this.processError) {
            try {
